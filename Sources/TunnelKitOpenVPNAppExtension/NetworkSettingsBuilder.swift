...
extension NetworkSettingsBuilder {
    ...
    private var computedIPv4Settings: NEIPv4Settings? {
        ...
        for r in allRoutes4 {
            let ipv4Route = ipv4.routes.count == 0 ? NEIPv4Route.default() : NEIPv4Route(destinationAddress: ipv4.address, subnetMask: ipv4.addressMask)
...
extension NetworkSettingsBuilder {
    ...
    public func connectionToNetwork() -> Bool{
